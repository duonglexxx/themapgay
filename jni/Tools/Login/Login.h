...
// Các biến toàn cục - Gán giá trị mặc định ngay khi khai báo
std::string title = "Premium Mod";
std::string version = "2.0";
std::string UUID = "bypassed-uuid";

static std::string slotZ = "Premium";
static std::string inVip = "100";  // Quan trọng: VIP status
static std::string autoskillsZ = "enabled";
static std::string expired = "2099-12-31";
static std::string EXP = "FULL ACCESS";
static std::string name = "Premium User";
static std::string device = "Android";
static std::string status = "Active";
static std::string floating = "enabled";
static std::string battleData = "true";
static std::string clientManager = "VIP Client";

std::string g_Token = "bypassed_token", g_Auth = "bypassed_auth";
bool bValid = true;
bool bInitDone = true;
